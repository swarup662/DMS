...
public class PermissionService
{
    ...
    public PermissionService(IHttpContextAccessor httpContextAccessor, IHttpClientFactory httpClientFactory, PermissionController permissionController)
    {
